    ...
    <div className="relative min-h-screen bg-zinc-950 text-white flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="relative w-full max-w-5xl">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white/5 backdrop-blur border border-white/15 rounded-2xl p-8 shadow-glow">
          ...
          <div className="bg-white/5 backdrop-blur border border-white/15 rounded-2xl p-8 shadow-glow2">
